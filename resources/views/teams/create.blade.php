        ...
        <div class="col-xxl-9">
            <div class="card bg-white border-0 rounded-10 mb-4">
                <div class="card-body p-4">
                    <h4 class="fw-semibold fs-18 border-bottom pb-20 mb-20">team Information</h4>
                    ...
                    <section>
                        ...
                        <form method="post" action="{{ route('teams.store') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="form-group position-relative">
                                            <x-text-input id="email" name="email" type="email"
                                                class="form-control text-dark ps-5 h-58" :value="old('email')" required
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="form-group position-relative">
                                            <x-text-input id="Mobile" name="Mobile" type='text' class="form-control text-dark ps-5 h-58"  :value="old('Mobile')" required autofocus autocomplete="Mobile" />
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="form-group position-relative">
                                            <x-text-input id="Years_of_Experience" name="Years_of_Experience" type="text"
                                                class="form-control text-dark ps-5 h-58" :value="old('Years_of_Experience')" required autofocus
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="form-group position-relative">
                                            <textarea class="form-control ps-5 text-dark" name="About_Me" placeholder="About Me ... " cols="30" rows="5" required autofocus >{{old('About_Me')}} </textarea>
                                            <i
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="form-group position-relative">
                                            <input type="url" name="Facebook" class="form-control text-dark ps-5 h-58" placeholder="URL"  value="{{old('Facebook')}}" required autofocus>
                                            <i
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="form-group position-relative">
                                            <input type="url" name="Twitter" class="form-control text-dark ps-5 h-58"  value="{{old('Twitter')}}" required autofocus placeholder="URL">
                                            <i
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="form-group position-relative">
                                            <input type="url" name="instagram" class="form-control text-dark ps-5 h-58" value="{{old('instagram')}}"  required autofocus placeholder="URL">
                                            <i
