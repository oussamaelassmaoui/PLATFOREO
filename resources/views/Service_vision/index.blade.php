...
@section('content')
                                        ...
                                        <td>
                                            <div class="dropdown action-opt">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end bg-white border box-shadow">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('Service_vision.edit', $item->id) }}">
                                                    ...
                                                    <li>
                                                        ...
                                                        <form action="{{ route('Service_vision.destroy', $item) }}" method="POST" class="dropdown-item" >
                                                            @csrf
                                                            @method('DELETE')
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        ...
        <div class="offcanvas-body p-4">
            <form  action="{{ route('Service_vision.store') }}" method="POST">
                @csrf
