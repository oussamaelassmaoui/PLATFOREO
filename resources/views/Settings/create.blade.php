...
@section('content')
    <form class="row g-3 needs-validation" action="{{ route('Settings.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-lg-12">
            <div class="form-group">
                <label class="label">banner Portfolio details</label>
                <div class="form-control h-100 text-center position-relative p-4 p-lg-5">
                    <div class="product-upload">
                        <label for="banner_blog" class="file-upload mb-0">
                            <i class="ri-upload-cloud-2-line fs-2 text-gray-light"></i>
                        ...
                        <input id="banner_Portfolio_details" class="@error('banner_Portfolio_details') is-invalid @enderror" type="file" name="banner_Portfolio_details">

                    </div>
                    @error('banner_Portfolio_details')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            </div>
