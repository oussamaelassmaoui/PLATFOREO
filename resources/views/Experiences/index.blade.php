...
@section('content')
    <div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
        <h3 class="mb-sm-0 mb-1 fs-18">Experiences</h3>
            ...
            <div class="card bg-white border-0 rounded-10 mb-4">
                <div class="card-body p-4">
                    <div class="d-sm-flex justify-content-between text-center align-items-center border-bottom pb-20 mb-20">
                        <h4 class="fw-semibold fs-18 mb-sm-0">Experiences</h4>
                                        ...
                                        <td class="text-start">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-10">
                                                    <h4 class="fw-semibold fs-14 mb-0">{{$item->name_company}}</h4>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="dropdown action-opt">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end bg-white border box-shadow">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('Experiences.edit', $item->id) }}">
                                                    ...
                                                    <li>
                                                        ...
                                                        <form action="{{ route('Experiences.destroy', $item) }}" method="POST" class="dropdown-item" >
                                                            @csrf
                                                            @method('DELETE')
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        <div class="offcanvas-header border-bottom p-4">
            <h5 class="offcanvas-title fs-18 mb-0" id="offcanvasRightLabel">Create Experience</h5>
            ...
            <form  action="{{ route('Experiences.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="text" name="name_company" class="form-control text-dark @error('name_company') is-invalid @enderror" placeholder=" name_company" value="{{ old('name_company') }}" >
                    @error('name_company')
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="text" name="subject" class="form-control text-dark @error('subject') is-invalid @enderror" placeholder=" subject" value="{{ old('subject') }}" required>
                    @error('subject')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="date" name="Start_Date" class="form-control text-dark @error('Start_Date') is-invalid @enderror" placeholder=" Start_Date" value="{{ old('Start_Date') }}" required>
                    @error('Start_Date')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="date" name="date_final" class="form-control text-dark @error('date_final') is-invalid @enderror" placeholder=" date_final" value="{{ old('date_final') }}" required>
                    @error('date_final')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                    </div>
