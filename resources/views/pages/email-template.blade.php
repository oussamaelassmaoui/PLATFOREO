...
<!-- Mirrored from themes.pixelstrap.com/voxo/email-template/welcome.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 01 Mar 2024 22:18:10 GMT -->
<head>
        ...
        <tbody>
            <tr>
                <td class="welcome-image mb-3" style="display: block;">
                    <img src="{{ asset('images/welcome.jpg') }}" style="width: 100%; margin-top: 20px;" alt="">
                </td>

                <td class="welcome-name mb-3" style="text-align: left; display: block;">
                    <h4 style="text-transform: capitalize; margin: 0; font-weight: 500; color: #232323">Hi Jonny and
                        welcome to Voxo!</h4>
                ...
                <td class="welcome-details mb-3" style="display: block;">
                    <p>If you have any question, please email us at <span>voxo@example.com</span> or vixit our
                        You can also chat with a real live human during our operating hours. They can
...
<!-- Mirrored from themes.pixelstrap.com/voxo/email-template/welcome.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 01 Mar 2024 22:18:17 GMT -->
</html>